...
# Wordlist CLDF word list from Gerhard Köbler's "Gotisches Wörterbuch" (2014)
...
property | value
 --- | ---
[dc:bibliographicCitation](http://purl.org/dc/terms/bibliographicCitation) | Köbler, Gerhard, ed. Gotisches Wörterbuch. Brill, 1989
...
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/martino-vic/koeblergothic/tree/b5f2eb2">martino-vic/koeblergothic b5f2eb2</a></li><li><a href="https://github.com/glottolog/glottolog/tree/v4.7">Glottolog v4.7</a></li><li><a href="https://github.com/concepticon/concepticon-data/tree/v3.1.0">Concepticon v3.1.0</a></li><li><a href="https://github.com/cldf-clts/clts/tree/v2.2.0">CLTS v2.2.0</a></li></ol>
...
[dc:extent](http://purl.org/dc/terms/extent) | 4764
...
[dc:extent](http://purl.org/dc/terms/extent) | 4211
...
[dc:extent](http://purl.org/dc/terms/extent) | 8508
...
[Entry_ID](http://cldf.clld.org/v1.0/terms.rdf#entryReference) | `string` | 
`Spacy` | `string` | 
`Parameter_ID` | `string` | 
